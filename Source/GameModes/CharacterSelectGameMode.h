 ...
 */
UCLASS()
class DUNGEONCRUSADES_API ACharacterSelectGameMode : public AGameModeBase
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	TWeakObjectPtr<AController> InitializePlayerAndController();

protected:

	UPROPERTY()
	TWeakObjectPtr<AController> StartingController;
